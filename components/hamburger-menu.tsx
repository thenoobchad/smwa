	...
	return (
		<div className="relative">
			<button
				...
				className="h-10 w-10 bg-blue-950 flex items-center justify-center flex-col space-y-1 relative z-99">
				<div
			...
			{isOpen && <div
				ref={menuRef}
				className={`absolute z-990 top-0 p-3 pt-4 pb-4 right-0 bg-blue-950 h-[80vh] w-50 transition-all delay-150 ${isOpen ? "translate-x-0" : "translate-x-[200%]"}`}>
